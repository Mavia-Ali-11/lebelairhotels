/*==========  Map  ==========*/
    ...
    function initialize_map() {
        ...
        Loc1 = new RichMarker({
            ...
            draggable: false,
            flat: true,
            content: '<div class="map-cb-wrap" id="Loc1">' +
        ...
        google.maps.event.addListener(Loc1, 'click', function() {
            $('.map-cb-wrap').removeClass('open');
            $('#Loc1').toggleClass('open');
        });

        var markerposition1 = new google.maps.LatLng(40.716715,-74.003352);
        Loc2 = new RichMarker({
            position: markerposition1,
            map: map,
            draggable: false,
            flat: true,
            content: '<div class="map-cb-wrap" id="Loc2">' +
                '<div class="locmark"><div class="maptb"><img src="assets/images/map-marker.png" alt="icon"></div></div>' +
                '<div class="cmb-wrap">' +
                    '<img src="assets/images/listing/1.jpg" alt="bg" class="img-responsive">' +
                    '<div class="loc-thumb">Cafe</div>' +
        ...
        google.maps.event.addListener(Loc2, 'click', function() {
            $('.map-cb-wrap').removeClass('open');
            $('#Loc2').toggleClass('open');
        });

        var markerposition2 = new google.maps.LatLng(40.716622,-74.007976);
        Loc3 = new RichMarker({
            position: markerposition2,
            map: map,
            draggable: false,
            flat: true,
            content: '<div class="map-cb-wrap" id="Loc3">' +
                '<div class="locmark"><div class="maptb"><img src="assets/images/map-marker.png" alt="icon"></div></div>' +
                '<div class="cmb-wrap">' +
                    '<img src="assets/images/listing/1.jpg" alt="bg" class="img-responsive">' +
                    '<div class="loc-thumb">Cafe</div>' +
        ...
        google.maps.event.addListener(Loc3, 'click', function() {
            $('.map-cb-wrap').removeClass('open');
            $('#Loc3').toggleClass('open');
        });

        var markerposition3 = new google.maps.LatLng(40.714898,-74.004500);
        Loc4 = new RichMarker({
            position: markerposition3,
            map: map,
            draggable: false,
            flat: true,
            content: '<div class="map-cb-wrap" id="Loc4">' +
                '<div class="locmark"><div class="maptb"><img src="assets/images/map-marker.png" alt="icon"></div></div>' +
                '<div class="cmb-wrap">' +
                    '<img src="assets/images/listing/1.jpg" alt="bg" class="img-responsive">' +
                    '<div class="loc-thumb">Cafe</div>' +
        ...
        google.maps.event.addListener(Loc4, 'click', function() {
            $('.map-cb-wrap').removeClass('open');
            $('#Loc4').toggleClass('open');
        });
